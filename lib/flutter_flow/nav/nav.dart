...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ChatDisplayPageWidget.routeName,
          path: ChatDisplayPageWidget.routePath,
          builder: (context, params) => ChatDisplayPageWidget(
            chatRow: params.getParam<ChatsRow>(
              'chatRow',
        ...
        FFRoute(
          ...
          builder: (context, params) => PostDetailsPageWidget(
            postDetailRow: params.getParam<FullPostsViewRow>(
              'postDetailRow',
              ParamType.SupabaseRow,
            ),
          ),
        ...
        FFRoute(
          name: OtherUserPageWidget.routeName,
          path: OtherUserPageWidget.routePath,
          builder: (context, params) => OtherUserPageWidget(
            userId: params.getParam(
              'userId',
              ParamType.String,
            ),
