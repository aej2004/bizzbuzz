    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case FullCommentsViewRow:
            return FullCommentsViewRow(data);
          case FullPostsViewRow:
            return FullPostsViewRow(data);
          case MessagesRow:
          ...
          case UserFollowerRelationshipRow:
            return UserFollowerRelationshipRow(data);
          default:
            return null;
        }
