...
class _EditProfilePageWidgetState extends State<EditProfilePageWidget> {
  ...
  void initState() {
    ...
    _model.pronounsTextFieldFocusNode1 ??= FocusNode();

    _model.pronounsTextFieldFocusNode2 ??= FocusNode();
        ...
        body: SafeArea(
          ...
          child: Padding(
            ...
            child: FutureBuilder<List<UserDataRow>>(
              future: UserDataTable().querySingleRow(
                          ...
                          child: Container(
                            ...
                            child: Image.network(
                              _model.profilePicture != null &&
                                  ...
                                  ? _model.uploadedFileUrl_uploadData7ry
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              if (selectedMedia != null &&
                                ...
                                safeSetState(() => _model
                                    .isDataUploading_uploadData7ry = true);
                                ...
                                try {
                                  ...
                                  _model.isDataUploading_uploadData7ry = false;
                                }
                                if (selectedUploadedFiles.length ==
                                    ...
                                    downloadUrls.length ==
                                        selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadData7ry =
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller: _model
                                      ...
                                      text: columnUserDataRow?.username,
                                    ),
                                    focusNode:
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller: _model
                                            .pronounsTextFieldTextController1 ??=
                                        TextEditingController(
                                      text: columnUserDataRow?.businessName,
                                    ),
                                    focusNode:
                                        _model.pronounsTextFieldFocusNode1,
                                    autofocus: false,
                                    enabled: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller: _model
                                            .pronounsTextFieldTextController2 ??=
                                        TextEditingController(
                                      text: columnUserDataRow?.businessType,
                                    ),
                                    focusNode:
                                        _model.pronounsTextFieldFocusNode2,
                                    autofocus: false,
                                    enabled: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                              ...
                              onTap: () async {
                                await UserDataTable().update(
                                  data: {
                                    ...
                                    'bio':
                                        _model.bioTextFieldTextController.text,
                                    'profile_pic':
                                        _model.profilePicture != null &&
                                                _model.profilePicture != ''
                                            ? _model.profilePicture
                                    ...
                                    'business_name': _model
                                        .pronounsTextFieldTextController1.text,
                                    'business_type': _model
                                        .pronounsTextFieldTextController2.text,
                                  },
