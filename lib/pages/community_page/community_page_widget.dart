  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      await UserDataTable().update(
        data: {
          'latitude': functions.latLngtoLat(_model.userLocation),
          'longitude': functions.latLngtoLng(_model.userLocation),
        },
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UserDataRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserDataRow> communityPageUserDataRowList = snapshot.data!;
