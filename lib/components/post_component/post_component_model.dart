...
class PostComponentModel extends FlutterFlowModel<PostComponentWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in PostComponent widget.
  List<PostLikeRelationRow>? likedRow;
  Completer<List<FullPostsViewRow>>? requestCompleter;
